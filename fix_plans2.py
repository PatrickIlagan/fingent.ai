...
pattern = re.compile(r'\{\(showAll \|\| isBudget\) && \(\s+<div className="space-y-8">\s+<div className="h-2 w-full bg-slate-100', re.DOTALL)

def replacer(match):
    return """      {(showAll || isBudget) && (

      ...
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <button 
            ...
            className={\`px-4 py-2 rounded-xl text-sm font-bold shadow-sm transition-colors flex items-center gap-2 \${isAdvanced ? 'bg-violet-600 hover:bg-violet-700 text-white' : 'bg-emerald-500 hover:bg-emerald-600 text-white'}\`}
          >
